        ...
        <div className="w-full max-w-md p-8 bg-white bg-opacity-10 backdrop-blur-md shadow-2xl rounded-3xl border border-white border-opacity-20 text-purple-500">
          ...
          <form onSubmit={handleSignUp} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-2 rounded-lg bg-gradient-to-r from-purple-500 to-violet-600 hover:opacity-90 transition duration-200 font-semibold disabled:opacity-50 text-white"
            >
