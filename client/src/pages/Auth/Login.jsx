  ...
  return (
    <AuthLayout>
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-violet-500 via-purple-600 to-indigo-600">
        <div className="w-full max-w-md p-8 bg-white bg-opacity-10 backdrop-blur-md shadow-2xl rounded-3xl border border-white border-opacity-20 text-white">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 rounded-lg bg-white bg-opacity-20 border border-white border-opacity-30 focus:outline-none focus:ring-2 focus:ring-violet-400 placeholder-white placeholder-opacity-70"
